...
class AVLTree
{
  ...
  private:
	...
	/* helper function to get imbalance factor and height */
	int imbalance_factor(const Node *sub_root) const;
	int get_height(const Node *sub_root) const;
	Node *get_max(Node *sub_root) const;
